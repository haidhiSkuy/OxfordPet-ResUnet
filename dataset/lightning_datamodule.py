...
from .torch_dataset import OxfordPetDataset
from torch.utils.data import DataLoader
from .augmentation import get_augmentation
from sklearn.model_selection import train_test_split


class OxfordDataModule(L.LightningDataModule):
    ...
    def setup(self, stage: str):
        ...
        self.train_dataset = OxfordPetDataset(x_train, y_train, self.transform['train'])
        self.val_dataset = OxfordPetDataset(x_test, y_test, self.transform['val'])
